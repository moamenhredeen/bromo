...
import me.moamenhredeen.bromo.features.HoverFeature;
...
final class HoverBench {
    ...
    void hoverOnBromo() throws Exception {
        ...
        var symbols = new me.moamenhredeen.bromo.symbol.WorkspaceScanner().scan(model.sourceRoots()).index();
        ...
        Baseline.checkRegression("hover.bromo-main", result, 50.0);
