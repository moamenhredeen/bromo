...
import com.almato.bromo.compiler.DiagnosticSeverity;
import com.almato.bromo.features.CompletionItemKind;
import com.almato.bromo.features.CompletionResult;
import com.almato.bromo.features.DefinitionResult;
import com.almato.bromo.features.HoverResult;
import com.almato.bromo.workspace.Positions;
...
final class Adapters {
    ...
    static org.eclipse.lsp4j.Diagnostic toLspDiagnostic(
            com.almato.bromo.compiler.Diagnostic d, CharSequence content) {
    ...
    static PublishDiagnosticsParams toPublishDiagnostics(
            URI uri,
            List<com.almato.bromo.compiler.Diagnostic> diagnostics,
