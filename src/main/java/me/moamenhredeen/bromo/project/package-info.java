...
///
/// Sealed [ProjectModel] type, [ProjectModelProvider] SPI, [me.moamenhredeen.bromo.project.classpath.ClasspathService].
...
/// [me.moamenhredeen.bromo.project.maven.resolver].
